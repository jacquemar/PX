...
const handleMethodChange = (event) => {
  ...
  const newDeliveryPrice = calculateDeliveryPrice(selectedCommune, selectedMethodValue);
  setDeliveryPrice(newDeliveryPrice.toString());
};
...
// Fonction pour générer et télécharger le fichier PDF
  ...
  <a href="#" className="text-2xl font-bold text-gray-800">Création du Ticket</a> 
...
<div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
  <div className="px-4 pt-8">
    ...
    <p className="text-gray-400">Vérifiez vos articles, et choisissez la méthode de livraison qui vous convient.</p>
  ...
  onChange={handleMethodChange} />
        ...
        <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
          <img className="w-14 object-contain" src="../../src/assets/standard.png" alt="" />
          <div className="ml-5">
            <span className="mt-2 font-semibold">Livraison standard </span>
            <p className="text-slate-500 text-sm leading-6">Livrée entre 3-4 jours</p>
          </div>
        </label>
      </div>
      <div className="relative">
  ...
  onChange={handleMethodChange}/>
        ...
        <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
          <img className="w-14 object-contain" src="../../src/assets/24h-01.png" alt="" />
          <div className="ml-5">
            <span className="mt-2 font-semibold">Livraison Xpress</span>
            <p className="text-slate-500 text-sm leading-6">Livrée sous 24h</p>
          </div>
        </label>
      </div>
            <div className="relative">
  ...
  onChange={handleMethodChange}/>
        ...
        <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_3">
          <img className="w-14 object-contain" src="../../src/assets/calendar-01.png" alt="" />
          <div className="ml-5">
            <span className="mt-2 font-semibold">Livraison calendrier</span>
            <p className="text-slate-500 text-sm leading-6">choisissez un jour de l'année</p>
          </div>
        </label>
      </div>
    </form>
  ...
  <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <p className="text-gray-400">Terminer la commande en fournissant les informations de facturation et de livraison</p>
    <div className="">
      <label for="quartier" className="mt-4 mb-2 block text-sm font-medium">Quartier</label>
      <div className="relative">
        <input type="text" id="quartier" name="quartier" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Bietry" />
        ...
        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
            ...
            <label htmlFor="commune" className="mt-4 mb-2 block text-sm font-medium">
        Commune
      </label>
      <div className="relative">
        <select
       ...
       <label for="numero" className="mt-4 mb-2 block text-sm font-medium">Numéro</label>
      <div className="relative">
        <input type="number" id=" numero" name="numero" value={phoneNumber} onChange={handlePhoneNumberChange} className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="+225 0102030405" />
        <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<div>
  <label htmlFor="card-no" className="mt-4 mb-2 block text-xl font-medium">
    Méthode de paiement
  </label>
        <form className="mt-5 grid gap-6">
        ...
        <div className="relative">
          ...
          >
            <img
              ...
              alt=""
            />
            <div className="mt-2 font-semibold">Payer à la livraison</div>
          </label>
        </div>
      </form>
 </div>
      ...
      <div className="mt-6 border-t border-b py-2">
        ...
        <div className="flex items-center justify-between">
          <p className="text-sm font-medium text-gray-900">Livraison/Expédition</p>
          <p className="font-semibold text-gray-900">{deliveryPrice}</p>
        </div>

                  {selectedMethod === 'radio_2' && (
    <div className="flex items-center justify-between">
      <p className="text-sm font-medium text-gray-400">Livraison Xpress</p>
      ...
      <div className="mt-6 flex items-center justify-between">
        ...
        <p className="text-2xl font-semibold text-gray-900"> {netAPayer} <span className="text-xs font-normal text-gray-400">FCFA</span></p>
      </div>
    </div>
