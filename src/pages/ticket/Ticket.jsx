      ...
      <div className="rounded-3xl bg-white shadow-lg">
        <div className="px-4 py-6 sm:px-8 sm:py-10">
          ...
          <div className="mt-6 text-center">
             <Link to="/checkout">
            <button type="button" disabled={cartItems.length === 0} className="group inline-flex w-full items-center justify-center rounded-md bg-pxcolor px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800">
              Créer le ticket
