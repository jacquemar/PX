...
<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a href="" class="flex items-center">
      <img src={logo} class="h-8 mr-3" alt="print xpress logo"></img>
      <span class="text-center text-2xl font-semibold whitespace-nowrap dark:text-white">Factures</span>
  </a>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      ...
      <li>
        <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Tickets</a>
      </li>
      <li>
        <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Catégories</a>
      </li>
      <li>
...
<section class="container mt-24 px-4 mx-auto">
    ...
    {filteredTickets.map((ticket) => (
        <tr key={ticket._id}>
            ...
            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                {new Date(ticket.date).toLocaleDateString()} {/* Convert date to a readable format */}
            </td>
    ...
    <div className='flex items-center text-pxcolor'><button onClick={handleResetTicketList}> EFFACER LES DONNEES PERSISTANTES</button></div>
</section>
</div>
  );
}
